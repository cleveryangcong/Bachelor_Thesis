...
def main():
    ...
    test = f.create_dataset(name_test, (n_days, 32, 120, 130, 2), dtype=np.float32, compression="gzip", compression_opts=9)
    truth = f.create_dataset(name_truth, (n_days, 32, 120, 130), dtype=np.float32, compression="gzip", compression_opts=9)
