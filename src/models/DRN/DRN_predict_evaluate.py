...
def DRN_predict_evaluate(var_num, lead_time):
    ...
    # DRN Model scores
    DRN_scores = crps(mu=DRN_preds[:, 0], sigma=DRN_preds[:, 1], y=t2m_y_test)
    ...
    model_filename = f"/Data/Delong_BA_Data/scores/DRN_scores/DRN_{var_names[var_num]}_lead_time_{lead_time}_scores.npy"
