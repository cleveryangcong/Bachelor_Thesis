...
def DRN_train(
   ...
   # Delete all unnecessary files, as to save memory:
    del train_var_denormed, dat_X_train_lead_all_denorm, dat_y_train_lead_all_denorm, drn_X_train_lead_array, land_sea_mask_dummy
    gc.collect()
    ...
    if save:
        ...
        model_filename = f"/Data/Delong_BA_Data/models/DRN_10_dummy/DRN_{var_names[var_num]}_lead_time_{lead_time}_{count}_denormed_dummy.h5"
    ...
    del drn_X_train_lead_array_mask, drn_embedding_train_lead_array, t2m_y_train
    gc.collect()
