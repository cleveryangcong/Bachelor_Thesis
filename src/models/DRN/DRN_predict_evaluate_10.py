...
def DRN_predict_evaluate(var_num, lead_time):
    ...
    for count in range(10):
        path = f'/Data/Delong_BA_Data/models/DRN_10/DRN_{var_names[var_num]}_lead_time_{lead_time}_{count}_denormed.h5'
    ...
    model_filename = f"/Data/Delong_BA_Data/scores/DRN_scores_10/DRN_{var_names[var_num]}_lead_time_{lead_time}_scores.npy"
