...
def main(var_num, lead_time):
    path_model = f"/Data/Delong_BA_Data/models/U_net/models_final/unet_model_var_{var_num}_lead_{lead_time}.h5"
    ...
    np.save(f'{path}U_net_var_{var_num}_lead_{lead_time}_preds.npy', predictions_unpad)
